...
question.innerHTML = "<h1>" + rq.question + "<h1/>";
option1.innerHTML = rq.checkbox1;
option2.innerHTML = rq.checkbox2;
option3.innerHTML = rq.checkbox3;
option4.innerHTML = rq.checkbox4;
}
